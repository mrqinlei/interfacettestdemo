...
import sys
sys.path.append('/Users/dev/Documents/pyrequest/db_fixture')
try:
...
datas = {
    #发布会数据
    'sign_event':[{'id':1,'name':'红米Pro发布会','`limit`':2000,'status':1,'address':'北京会展中心','start_time':'2017-08-20 14:00:00'},
    ...
    # 嘉宾表数据
    'sign_guest': [
        {'id': 1, 'realname': 'alen', 'phone': 13511001100, 'email': 'algen@mail.com', 'sign': 0, 'event_id': 1},
        {'id': 2, 'realname': 'has sign', 'phone': 13511001101, 'email': 'algen@mail.com', 'sign': 0, 'event_id': 1},
